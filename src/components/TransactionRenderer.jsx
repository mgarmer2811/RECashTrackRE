...
export default function TransactionRenderer({ userId }) {
  ...
  useEffect(() => {
    ...
    const fetchTransactions = async () => {
      try {
        let url = `http://localhost:5050/api/transactions/get?userId=${userId}`;
  ...
  return (
    <div className="w-full h-full bg-white rounded-xl shadow-2xl p-4">
      ...
      <div className="w-full space-y-3 overflow-y-auto max-h-[50vh] md:max-h-[70vh] pr-2 mt-4">
